// Currency list with comprehensive world currencies
export const WORLD_CURRENCIES = [
  ...
  { code: 'UYW', name: 'Uruguayan Peso (Indexed Units)', symbol: 'UYW' },
  { code: 'UZS', name: 'Uzbekistan Som', symbol: 'лв' },
  { code: 'VED', name: 'Venezuelan Bolívar Soberano', symbol: 'Bs.' },
